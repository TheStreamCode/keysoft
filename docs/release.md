...
Current release target: Keysoft 1.8, Android versionCode 80.
...
For the 1.8 Android production release, `app.config.js` uses `version: "1.8"` and `android.versionCode: 80`.
